 ...
 */
char *build_extension_regex_string(const char board[BOARD_SIZE][BOARD_SIZE], const char hand[HAND_SIZE], struct board_word *bw);

/**
   TODO
 */
char *build_hook_regex_string(const char board[BOARD_SIZE][BOARD_SIZE], const char hand[HAND_SIZE], struct play *play);

/**
   TODO
*/
char *build_perpendicular_regex_string(const char board[BOARD_SIZE][BOARD_SIZE], const char hand[HAND_SIZE], struct board_word *bw);

/**
   This function takes a word and searches for it in a wordlist. If a match is
 ...
 */
struct vec *find_all_extensions(const char board[BOARD_SIZE][BOARD_SIZE], const char *wordlist, const char hand[HAND_SIZE], struct board_word *bw);

/**
   TODO
 */
struct vec *find_all_hooks(const char board[BOARD_SIZE][BOARD_SIZE], const char *wordlist, const char hand[HAND_SIZE], struct play *play);

/**
   TODO
 */
struct vec *find_all_perpendiculars(const char board[BOARD_SIZE][BOARD_SIZE], const char *wordlist, const char hand[HAND_SIZE], struct board_word *bw);
